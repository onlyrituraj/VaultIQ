...
const Header = () => {
  ...
  if (location.pathname === '/authentication-wallet-connection') {
    return null;
  }
          ...
          <div className="relative" ref={walletRef}>
            ...
            >
              ...
              <span className="hidden sm:inline font-data">
                {walletStatus.connected ? truncateAddress(walletStatus.address) : 'Connect'}
              </span>
                ...
                <div className="p-4">
                  {walletStatus.connected ? (
                    ...
                    <div className="text-center">
                      <p className="text-sm text-text-secondary mb-3">Connect your wallet to continue</p>
